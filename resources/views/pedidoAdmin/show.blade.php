...
@endforeach 
	...
	<h3><td><h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
@if ($ped->tipo === 0)
  <i class="	fa fa-clock-o fa-2x fa-fw" aria-hidden="true"></i>&nbsp;Pendiente
@elseif ($ped->tipo === 1)
   <i class="	fa fa-check fa-2x fa-fw" aria-hidden="true"></i>&nbsp;Completado
@elseif ($ped->tipo === 2)
    <i class="	fa fa-times fa-2x fa-fw" aria-hidden="true"></i>&nbsp;Cancelado
@endif
